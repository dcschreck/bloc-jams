...
var setCurrentTimeInPlayerBar = function(currentTime) {
    ...
    $currentTime.html(filterTimeCode(currentTime));
}

var setTotalTimeInPlayerBar = function(totalTime) {
    var $totalTime = $('.total-time');
    $totalTime.html(filterTimeCode(totalTime));
}
...
var togglePlayFromPlayerBar = function() {
    ...
    var playing = getSongNumberCell(currentlyPlayingSongNumber);

    if (currentSoundFile.isPaused()) {
        currentSoundFile.play();
        $playPausePlayerBar.html(playerBarPauseButton);
        playing.html(pauseButtonTemplate);
    } else {
        currentSoundFile.pause();
        $playPausePlayerBar.html(playerBarPlayButton);
        playing.html(playButtonTemplate);
    }
};
